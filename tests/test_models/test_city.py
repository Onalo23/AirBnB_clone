...
class TestCity_instantiation(unittest.TestCase):
    """Unittests use for testing instantiation of a City class"""
...
class TestCity_save(unittest.TestCase):
    """Unittests use for testing save method of City class"""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests use for testing to_dict method of City class"""
